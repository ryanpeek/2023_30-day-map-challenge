...
my_image <-  png::readPNG("figs/day09-hexagons_3d.png")
gall <- g1 + grid::rasterGrob(my_image) 

ggsave(filename = glue("figs/day09_hexagons_3d.png"), width = 11, height = 8.5, dpi = 300)

# alt
my_image <-  png::readPNG("temp/titled.png")
gall <- g1 + grid::rasterGrob(my_img)
gall

gall <- g1 + patchwork::inset_element(grid::rasterGrob(my_img), 0.7, 0.2, 1, 1, clip = FALSE) & theme(plot.background = element_rect(fill = "#252a32", colour = "#252a32"))
gall
